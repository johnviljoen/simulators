...
import quadcopter.utils as utils
...
def get_quad_params():
    ...
    params["mixerFM"]    = utils.makeMixerFM.pytorch(params) # Make mixer that calculated Thrust (F) and moments (M) as a function on motor speeds
